...
from baseline_b.utils_nic_2 import get_eval_score
...
def evaluate(beam_size_, data_folder, data_name, device, encoder, decoder, word_map, vocab_size, rev_word_map, robust):
    ...
    with torch.no_grad():
        for i, (phase, amp, caps, caplens, all_caps) in enumerate(tqdm(loader)):
            ...
            # Encode
            encoder_out = encoder(phase, amp, phase)
...
if __name__ == '__main__':
    ...
    checkpoints = ['BEST_ResNet50_nic_2.pth.tar', 'BEST_ResNet101_nic_2.pth.tar', 'LESS_ResNeXt101_nic_2.pth.tar']
