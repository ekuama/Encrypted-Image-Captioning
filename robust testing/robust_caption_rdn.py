...
def caption_search(image_name, name, robust):
    ...
    if name == "ResNet50":
        checkpoint = 'LESS_ResNet50_rdn.pth.tar'
    elif name == "ResNet101":
        checkpoint = 'LESS_ResNet101_rdn.pth.tar'
    else:
        checkpoint = 'LESS_ResNeXt101_rdn.pth.tar'
...
for r in robustness:
    for cnn in cnn_names:
        ...
        caption_nic.to_csv('results_csv/' + cnn + '_caption_rdn_exclude_0.6.csv', index=False)
