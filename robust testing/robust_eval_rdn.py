...
def evaluate(beam_size_, data_folder, data_name, device, encoder, decoder, word_map, vocab_size, rev_word_map, robust):
    ...
    with torch.no_grad():
        for i, (phase, amp, caps, caplens, all_caps) in enumerate(tqdm(loader)):
            ...
            # Encode
            _, encoder_out = encoder(phase, amp)
...
if __name__ == '__main__':
    ...
    folder = 'D:/PycharmProjects/Captioning_Encrypted/phase_amp_new/'
    ...
    checkpoints = ['LESS_ResNet50_rdn.pth.tar', 'LESS_ResNet101_rdn.pth.tar', 'LESS_ResNeXt101_rdn.pth.tar']
