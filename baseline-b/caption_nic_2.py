...
def caption_search(image_name, name):
    ...
    if name == "ResNet50":
        checkpoint = 'results/BEST_ResNet50_nic_2.pth.tar'
    elif name == "ResNet101":
        checkpoint = 'results/BEST_ResNet101_nic_2.pth.tar'
    else:
        checkpoint = 'results/LESS_ResNeXt101_nic_2.pth.tar'
...
for cnn in cnn_names:
    ...
    caption_nic.to_csv(cnn + '_caption_nic_2.csv', index=False)
